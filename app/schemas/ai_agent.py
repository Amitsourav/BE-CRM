...
PROVIDER_OPTIONS = {
    ...
    "tts_models": {
        ...
        "smallest": [
            {"value": "lightning-v3.1", "label": "Lightning v3.1 (latest, 104 voices, Hindi)"},
            {"value": "lightning-v2", "label": "Lightning v2 (98 voices)"},
            {"value": "lightning", "label": "Lightning v1 (33 voices, legacy)"},
        ],
        "elevenlabs": [
    ...
    "tts_voices_english": {
        ...
        "smallest": [
            {"value": "maithili", "label": "Maithili (Female Hindi/English, fast)"},
            {"value": "advika", "label": "Advika (Female Hindi/English, fast)"},
            {"value": "sana", "label": "Sana (Female Hindi/English, fast)"},
            {"value": "avery", "label": "Avery (Female English, fast)"},
            {"value": "sophia", "label": "Sophia (Female English, fast)"},
            {"value": "neel", "label": "Neel (Male Hindi/English, fast)"},
            {"value": "arjun", "label": "Arjun (Male Hindi/English, fast)"},
            {"value": "robert", "label": "Robert (Male English, fast)"},
        ],
    },
    "tts_providers_hindi": [
    ...
    "tts_voices_hindi": {
        ...
        "smallest": [
            ...
            {"value": "advika", "label": "Advika (Female Hindi/English, fast)"},
            {"value": "sana", "label": "Sana (Female Hindi/English, fast)"},
            {"value": "devansh", "label": "Devansh (Male Hindi, fast)"},
            {"value": "neel", "label": "Neel (Male Hindi/English, fast)"},
            {"value": "arjun", "label": "Arjun (Male Hindi/English, fast)"},
        ],
    },
    ...
    "voices": {
        ...
        # Smallest lightning-v3.1 voice catalog (104 voices total).
        # IMPORTANT: these voices ONLY work with model "lightning-v3.1".
        # v1 voices (mithali, emily, sarah) do NOT work on v3.1.
        "smallest": {
            "female": [
                {"value": "maithili", "label": "Maithili (Hindi/English)"},
                {"value": "advika", "label": "Advika (Hindi/English)"},
                {"value": "aisha", "label": "Aisha (Hindi/English)"},
                {"value": "ishani", "label": "Ishani (Hindi/English)"},
                {"value": "yuvika", "label": "Yuvika (Hindi/English)"},
                {"value": "sana", "label": "Sana (Hindi/English)"},
                {"value": "divya", "label": "Divya (Hindi/English)"},
                {"value": "avni", "label": "Avni (Hindi/English)"},
                {"value": "kavya", "label": "Kavya (Hindi/English)"},
                {"value": "sameera", "label": "Sameera (Hindi/English)"},
                {"value": "sunidhi", "label": "Sunidhi (Hindi/English)"},
                ...
                {"value": "rachel", "label": "Rachel (English)"},
                {"value": "olivia", "label": "Olivia (English)"},
            ],
            "male": [
                {"value": "devansh", "label": "Devansh (Hindi)"},
                {"value": "neel", "label": "Neel (Hindi/English)"},
                {"value": "arjun", "label": "Arjun (Hindi/English)"},
                {"value": "vivaan", "label": "Vivaan (Hindi/English)"},
                {"value": "gaurav", "label": "Gaurav (Hindi/English)"},
                {"value": "hitesh", "label": "Hitesh (Hindi/English)"},
                {"value": "vaibhav", "label": "Vaibhav (Hindi/English)"},
                {"value": "kunal", "label": "Kunal (Hindi/English)"},
                {"value": "siddharth", "label": "Siddharth (Hindi/English)"},
                {"value": "mohit", "label": "Mohit (Hindi/English)"},
                {"value": "mihir", "label": "Mihir (Hindi/English)"},
                {"value": "aarush", "label": "Aarush (Hindi/English)"},
                {"value": "parth", "label": "Parth (Hindi/English)"},
                {"value": "robert", "label": "Robert (English)"},
                {"value": "ethan", "label": "Ethan (English)"},
            ],
        },
        "elevenlabs": {
            "female": [
