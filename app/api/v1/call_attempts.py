...
async def list_calls(
    ...
    telecaller_id: list[uuid.UUID] | None = Query(None, description="Repeatable; any of these callers"),
    call_status: list[str] | None = Query(None, description="Repeatable; any of these statuses"),
    call_type: list[str] | None = Query(None, description="Repeatable; manual / ai_campaign / etc."),
    sentiment: list[str] | None = Query(None, description="Repeatable; positive / neutral / negative"),
